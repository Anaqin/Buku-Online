    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body p-4">
            <form method="post" enctype="multipart/form-data">
                    ...
                    if (isset($_FILES['cover']) && $_FILES['cover']['error'] == 0) {
                        ...
                        if (in_array($file_ext, $allowed_ext)) {
                            ...
                            if (move_uploaded_file($file_tmp, $upload_path)) {
                                ...
                                $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori,judul,penulis,penerbit,tahun_terbit,deskripsi,cover,stok) 
                                values ('$id_kategori','$judul','$penulis','$penerbit','$tahun_terbit','$deskripsi','$new_file_name','$stok')");
                ...
                <div class="row mb-4">
                    <label class="col-md-3 col-form-label fw-semibold">Stok Buku</label>
                    <div class="col-md-9">
                        <input type="number" name="stok" class="form-control shadow-sm" style="width: 50%" min="1"
                            required>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-9">
                        <input type="file" name="cover" class="form-control shadow-sm" style="width: 50%"
