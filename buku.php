                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 150px;">
                                ...
                                <?php } else { ?>
                                <span class="text-muted fst-italic"><i class="fas fa-image me-1"></i>Belum Ada
                                    Sampul</span>
                                <?php } ?>
                            </td>
                            <td>
                                        ...
                                        <div class="modal-content rounded-4">
                                            <div class="modal-header bg-danger text-white">
                                                <h5 class="modal-title"
                                                    id="hapusModalLabel<?php echo $data['id_buku']; ?>">
...
<?php if (isset($_GET['error']) && $_GET['error'] === 'buku_dipinjam'): ?>
<div class="modal fade" id="errorModal" tabindex="-1" aria-labelledby="errorModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title" id="errorModalLabel">
                    <i class="fas fa-circle-exclamation me-2"></i>Buku Sedang Dipinjam
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
            </div>
            <div class="modal-body">
                Buku ini tidak dapat dihapus karena sedang dipinjam oleh satu atau lebih peminjam.
            </div>
            <div class="modal-footer">
